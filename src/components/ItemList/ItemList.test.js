...
const getItemListWithContext = (context = {}) => {
    ...
    return require('./ItemList').ItemList;
};
  
describe('<ProjectsList />', () => {
    it('renders without crashing', () => {
        const ItemList = getItemListWithContext();
        const div = document.createElement('div');
        ReactDOM.render(<BrowserRouter>{ItemList}</BrowserRouter>, div);
