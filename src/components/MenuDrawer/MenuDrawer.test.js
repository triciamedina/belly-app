...
const getMenuDrawerWithContext = (context = {}) => {
    ...
    return require('./MenuDrawer').MenuDrawer;
};
  
describe('<ProjectsList />', () => {
    it('renders without crashing', () => {
        const MenuDrawer = getMenuDrawerWithContext();
        const div = document.createElement('div');
        ReactDOM.render(<BrowserRouter>{MenuDrawer}</BrowserRouter>, div);
