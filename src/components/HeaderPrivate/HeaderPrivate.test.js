...
const getHeaderPrivateWithContext = (context = {}) => {
    ...
    return require('./HeaderPrivate').HeaderPrivate;
};
  
describe('<ProjectsList />', () => {
    it('renders without crashing', () => {
        const HeaderPrivate = getHeaderPrivateWithContext();
        const div = document.createElement('div');
        ReactDOM.render(<BrowserRouter>{HeaderPrivate}</BrowserRouter>, div);
