...
const getShareModalWithContext = (context = {}) => {
    ...
    return require('./ShareModal').ShareModal;
};
  
describe('<ProjectsList />', () => {
    it('renders without crashing', () => {
        const ShareModal = getShareModalWithContext();
        const div = document.createElement('div');
        ReactDOM.render(<BrowserRouter>{ShareModal}</BrowserRouter>, div);
