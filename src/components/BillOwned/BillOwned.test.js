...
const getBillOwnedWithContext = (context = {}) => {
    ...
    return require('./BillOwned').BillOwned;
};
  
describe('<ProjectsList />', () => {
    it('renders without crashing', () => {
        const BillOwned = getBillOwnedWithContext();
        const div = document.createElement('div');
        ReactDOM.render(<BrowserRouter>{BillOwned}</BrowserRouter>, div);
